...
public class ScaleObstacles : MonoBehaviour
{
    ...
    [SerializeField] Vector3 scaleVector = new Vector3(10f, 10f, 10f);
    [SerializeField] float period = 2f; // time of one full circle

    //todo remove from inspector later
    float scaleFactor; //0 for not moved, 1 for fully moved
    Vector3 startingPos;
    ...
    void Update()
    {
        ...
        scaleFactor = rawSinWave / 2f + 0.5f; // goes from 0 to 1
